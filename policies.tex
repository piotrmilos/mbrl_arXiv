...
In each of the iterations, the agent is trained inside the latest world model using PPO.
...
% While implementing the above training procedure we investigated  what is the sweet-spot for the amount of supervised data used and model imperfections which still can be handled with an RL algorithm -- we provide more details in Section \ref{sec:ablations}, paragraph {\bf Model-based iterations}. 
